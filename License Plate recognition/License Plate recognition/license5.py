print("Note:\n  1.To run this code kindly install tesseract-ocr and copy the path of tesseract-ocr in your system advanced settings.\n  2.you also need to install packages like pytessract,opencv,numpy,etc.")
...
while loop:
    ...
    def main():
        ...
        print("1. Process Live Camera feed(press q to qiut process on opencv window)")
